...
IPAddress staticIP(192,168,0,170); // phong ngoai
//IPAddress staticIP(192,168,0,171); // phong can bo
//IPAddress staticIP(192,168,0,175); // phong may
...
//const char* pass = "heodaugau";
//const char* ssid = "p2808";
...
//      JsonObject& json_buffer = jsonBuffer.parseObject(data);
//      const char* world = json_buffer["light"];
      data.toCharArray(buffer_weather, data.length()+1);
      buffer_weather[data.length() + 1] = '\0';
