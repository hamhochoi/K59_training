...
def save_data(data):
    ...
    sql = """INSERT INTO Rule_Cu(rule_id,
...
def load_data_from_db(n_record=None):
    ...
    if (n_record == None):
        query_statement = 'SELECT * FROM Rule_Cu WHERE rule_status = "enable" ORDER BY insert_time DESC'
    else:
        query_statement = 'SELECT * FROM Rule_Cu WHERE rule_status = "enable" ORDER BY insert_time DESC LIMIT' + str(n_record)
...
def delete_data(data):
    ...
    sql = 'UPDATE Rule_Cu SET rule_status = "%s" WHERE rule_id = "%s"' % (rule_status, rule_id)
    try:
        # Execute the SQL command
        cursor.execute(sql)
        # Commit your changes in the database
...
if __name__ == "__main__":
    ...
    cursor.execute("""CREATE TABLE IF NOT EXISTS Rule_Cu(
